...
var car = {
    ...
    addCar: function(Car, callback) {
        ...
        if (Car.car_img != '') {
            ...
            return db.query("insert into car_tbl(car_name,car_color,car_type,car_img,car_rate,car_details,car_category,fk_traveller_id) values(?,?,?,?,?,?,?,?)", [Car.car_name, Car.car_color, Car.car_type, path1, Car.car_rate, Car.car_details, Car.car_category, Car.fk_traveller_id], callback);
