    ...
    addCar: function(Car,filename,callback) {
      /*  var dt = new Date();
        ...
        if (Car.car_img != '') {
            ...
            return db.query("insert into car_tbl(car_name,car_color,car_type,car_img,car_rate,car_details,car_category,fk_traveller_id,car_status) values(?,?,?,?,?,?,?,?,?)", [Car.car_name, Car.car_color, Car.car_type,filename, Car.car_rate, Car.car_details, Car.car_category, Car.fk_traveller_id,Car.car_status], callback);
