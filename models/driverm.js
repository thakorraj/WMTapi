...
var driver={
    ...
    addDriver:function(Driver,callback)
    {
     ...
     return db.query("insert into driver_tbl(driver_name,driver_license_no,Mobile_no,fk_traveller_id) values(?,?,?,?)",[Driver.driver_name,Driver.driver_license_no,Driver.Mobile_no,Driver.fk_traveller_id],callback);
