...
var traveller = {
    ...
    getTravellerByDriver:function(id,callback)
    {
        return db.query("select * from driver_tbl c,traveller_tbl t where t.traveller_id=c.fk_traveller_id and c.fk_traveller_id=? and c.driver_status='1'",[id],callback);
    }
};
